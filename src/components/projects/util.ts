...
import BudgetifyImg from "../../assets/portfolio/budgetify.png";
...
export const PROJECTS_DATA: ProjectItem[] = [
  {
    id: 1,
    title: "Natours",
    category: [ProjectCategory.WebApplication, ProjectCategory.All],
    image: natoursImg,
    description:
  ...
  },
  {
    id: 2,
    title: "Forkify",
    category: [ProjectCategory.UIUXDesign, ProjectCategory.All],
    image: forkifyImg,
    description:
  ...
  },
  {
    ...
    category: [ProjectCategory.MobileApplication, ProjectCategory.All],
    image: aspironImg,
    description:
