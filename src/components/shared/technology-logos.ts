...
import { ReactComponent as ReactNewLogo } from "../../assets/tech-stack-icons/react-native.svg";
...
export const ExpressJsTech = { name: "Express.js", icon: ExpressJsLogo };
export const GraphQLTech = { name: "GraphQL", icon: GraphqlLogo };
export const MikroOrmTech = { name: "MikroORM", icon: MikroOrmLogo };
...
// DevOps & Cloud
export const AwsTech = { name: "AWS Serverless / CDK", icon: AwsLogo };
export const DockerTech = { name: "Docker", icon: DocketLogo };
export const CircleCITech = { name: "CirceleCI", icon: CirceleCILogo };
export const GithubActionsTech = { name: "Github Actions", icon: GithubLogo };
export const FastlaneTech = { name: "Fastlane", icon: FastLaneLogo };

// Testing
export const CypressTech = { name: "Cypress", icon: CypressLogo };
export const JestTech = { name: "Jest", icon: JestLogo };
export const TestFlightTech = { name: "TestFlight", icon: TestFlightLogo };
export const RTLTech = { name: "React Testing Library", icon: RTLLogo };

// Business Tools
export const Dynamics365Tech = {
